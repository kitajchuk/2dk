...
*******************************************************************************/
    ...
    render () {
        ...
        this.player.renderLayer.context.scale(
            flipX ? -1 : 1,
            flipY ? -1 : 1
        );
    ...
    renderDebug () {
        ...
        // Footbox
        this.player.renderLayer.context.fillStyle = Config.colors.green;
        this.player.renderLayer.context.fillRect(
            this.offset.x + ( this.data.hitbox.x / this.scale ),
...
*******************************************************************************/
    applyOpacity () {
        if ( this.opacity ) {
            this.player.renderLayer.context.globalAlpha = this.opacity;
        }
