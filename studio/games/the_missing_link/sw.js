...
const CACHE_URLS = [
    ...
    "assets/sounds/bgm-crystal-cave.mp3",
    "assets/sounds/bgm-green-town-short.mp3",
    ...
    "assets/sounds/bgm-mysterious-ambience.mp3",
    ...
    "assets/sounds/bgm-simple-shop.mp3",
    "assets/sounds/bgm-snowfall.mp3",
    "assets/sounds/bgm-spirit-dance.mp3",
    "assets/sounds/bgm-world-theme.mp3",
    "assets/sounds/sfx-boomerang.mp3",
    ...
    "assets/sounds/sfx-energy-charge.mp3",
    "assets/sounds/sfx-heart.mp3",
    "assets/sounds/sfx-item-get.mp3",
    "assets/sounds/sfx-jump.mp3",
    "assets/sounds/sfx-key.mp3",
    "assets/sounds/sfx-magic-regain.mp3",
    ...
    "maps/beneath-the-cathedral.json",
    "maps/beneath-the-grave.json",
    "maps/beneath-the-moblin-hideout.json",
    "maps/beneath-the-river.json",
    "maps/beneath-the-rooster.json",
    "maps/bottom-of-the-well.json",
    "maps/cathedral-of-the-cursed.json",
    "maps/fishermans-shack.json",
    "maps/forest-cavern.json",
    "maps/graveyard-residence.json",
    "maps/great-fairy-fountain.json",
    "maps/great-lake-temple-level-2.json",
    "maps/great-lake-temple.json",
    "maps/great-lake.json",
    "maps/hero-s-tomb.json",
    "maps/hillside-residence.json",
    "maps/lakeside-residence.json",
    "maps/lakeview-mountain-pass.json",
    "maps/lost-corner-of-the-world.json",
    "maps/master-shinjis-house.json",
    "maps/old-hags-nest.json",
    "maps/plateau-cavern.json",
    "maps/plateau-residence.json",
    "maps/sport-fishing-shop.json",
    "maps/sword-masters-house.json",
    "maps/treetop-village.json",
