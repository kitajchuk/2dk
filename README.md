...
[This issue here](https://github.com/kitajchuk/2dk/issues/30) is tracking towards an MVP version with the ability to create functional sandbox games without writing a lick of code using the studio software and running in the 2dk engine.
